...
def test_create_ticket():
    ...
    joft.actions.create_ticket(create_ticket_action, mock_jira_session, mock_reference_pool)
...
def test_update_ticket():
    ...
    update_ticket_template = {
        ...
        "reference_id": "issue",
        "fields": {
            "customAfield_12311140": "test update"
        }
    }
    ...
    mock_reference_pool["issue"] = mock_reference_issue
    joft.actions.update_ticket(update_ticket_action, mock_jira_session, mock_reference_pool)
